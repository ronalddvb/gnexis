...
const team = [
  { name: "Ronald Vera", role: "Fundador & CEO", initials: "RV" },
  { name: "Equipo de Ingeniería IA", role: "Agentes & Plataforma", initials: "IA" },
  { name: "Equipo de Producto", role: "Diseño & Desarrollo Web", initials: "PD" },
];
      ...
      <Reveal>
        <section className="container-gnexis border-t border-white/10 py-16 md:py-20">
          ...
          <div className="mt-14 grid grid-cols-1 gap-10 sm:grid-cols-3">
            {team.map((t) => (
              <div key={t.name}>
                <div className="flex aspect-[4/5] w-full items-center justify-center rounded-[24px] bg-gradient-to-br from-electric-iris/20 via-white/5 to-deep-verdant/20">
                  <span className="text-[42px] font-normal text-white/30">
                    {t.initials}
                  </span>
                </div>
